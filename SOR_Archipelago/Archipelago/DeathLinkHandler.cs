...
namespace SOR_Archipelago.Archipelago
{
    public class DeathLinkHandler
    {
        ...
        private void DeathLinkReceived(DeathLink deathLink)
        {
            ...
            SorArch.BepinLogger.LogDebug(deathLink.Cause.IsNullOrWhiteSpace()
        ...
        public void KillPlayer()
        {
            try
            {
                ...
                SorArch.BepinLogger.LogMessage(cause);
            }
            catch (Exception e)
            {
        ...
        public void SendDeathLink()
        {
            try
            {
                ...
                SorArch.BepinLogger.LogMessage("sharing your death...");
