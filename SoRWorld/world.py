...
class SoRWorld(World):
    ...
    options_dataclass = sor_options.SoROptions
    options: sor_options.SoROptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.SoRItem:
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        ...
        return self.options.as_dict(
            "mayor_only", "become_mayor", "big_quests_completed", "achievements_completed"
        )